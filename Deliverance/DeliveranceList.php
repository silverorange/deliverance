...
abstract class DeliveranceList
{
    ...
    abstract public function subscribe($address, array $info = []);
     ...
     *
     * @return int status code for a queued response
     */
